...
#define FIT_SUB_SPORT_ADVENTURE_RACE                                            (FIT_CAST(FIT_SUB_SPORT, 82)) // Multisport/Running
...
#define FIT_MANUFACTURER_UNA_WATCH                                              (FIT_CAST(FIT_MANUFACTURER, 351))
#define FIT_MANUFACTURER_TYMEWEAR                                               (FIT_CAST(FIT_MANUFACTURER, 352))
...
#define FIT_GARMIN_PRODUCT_FR970                                                (FIT_CAST(FIT_GARMIN_PRODUCT, 4565))
#define FIT_GARMIN_PRODUCT_FR570_LARGE                                          (FIT_CAST(FIT_GARMIN_PRODUCT, 4570))
#define FIT_GARMIN_PRODUCT_FR570_SMALL                                          (FIT_CAST(FIT_GARMIN_PRODUCT, 4574))
...
#define FIT_GARMIN_PRODUCT_FENIX7_PRO_SOLAR_NO_WIFI                             (FIT_CAST(FIT_GARMIN_PRODUCT, 4595))
...
#define FIT_GARMIN_PRODUCT_FR170_MUSIC                                          (FIT_CAST(FIT_GARMIN_PRODUCT, 4814))
#define FIT_GARMIN_PRODUCT_FR170                                                (FIT_CAST(FIT_GARMIN_PRODUCT, 4815))
...
#define FIT_GARMIN_PRODUCT_FR70_2026                                            (FIT_CAST(FIT_GARMIN_PRODUCT, 4916))
#define FIT_GARMIN_PRODUCT_FENIX9_PRO_43MM                                      (FIT_CAST(FIT_GARMIN_PRODUCT, 4952))
#define FIT_GARMIN_PRODUCT_FENIX9_PRO_47MM                                      (FIT_CAST(FIT_GARMIN_PRODUCT, 4953))
#define FIT_GARMIN_PRODUCT_FENIX9_PRO_51MM                                      (FIT_CAST(FIT_GARMIN_PRODUCT, 4954))
#define FIT_GARMIN_PRODUCT_FENIX9_PRO_SOLAR_47MM                                (FIT_CAST(FIT_GARMIN_PRODUCT, 4955))
#define FIT_GARMIN_PRODUCT_FENIX9_PRO_SOLAR_51MM                                (FIT_CAST(FIT_GARMIN_PRODUCT, 4956))
#define FIT_GARMIN_PRODUCT_FENIX9_43MM                                          (FIT_CAST(FIT_GARMIN_PRODUCT, 5133))
#define FIT_GARMIN_PRODUCT_FENIX9                                               (FIT_CAST(FIT_GARMIN_PRODUCT, 5134)) // 47mm & 57mm
...
#define FIT_GARMIN_PRODUCT_CIRQA_SMART_BAND                                     (FIT_CAST(FIT_GARMIN_PRODUCT, 5019))
#define FIT_GARMIN_PRODUCT_D2_MACH2_PRO                                         (FIT_CAST(FIT_GARMIN_PRODUCT, 5056))
...
#define FIT_GARMIN_PRODUCT_TRAINING_PEAKS_VIRTUAL_IOS                           (FIT_CAST(FIT_GARMIN_PRODUCT, 30059))
#define FIT_GARMIN_PRODUCT_TRAINING_PEAKS_VIRTUAL_ANDROID                       (FIT_CAST(FIT_GARMIN_PRODUCT, 30060))
#define FIT_GARMIN_PRODUCT_TRAINING_PEAKS_VIRTUAL_WINDOWS                       (FIT_CAST(FIT_GARMIN_PRODUCT, 30061))
#define FIT_GARMIN_PRODUCT_TRAINING_PEAKS_VIRTUAL_MAC_OS                        (FIT_CAST(FIT_GARMIN_PRODUCT, 30062))
#define FIT_GARMIN_PRODUCT_TRAINING_PEAKS_VIRTUAL_APPLE_TV                      (FIT_CAST(FIT_GARMIN_PRODUCT, 30063))
...
#define FIT_ACTIVITY_TYPE_WHEELCHAIR_PUSHING                                    (FIT_CAST(FIT_ACTIVITY_TYPE, 13))
...
typedef struct
{
   ...
   FIT_FIELD_CONVERT fields[FIT_MAX_FIELD_COUNT];
} FIT_MESG_CONVERT;
...
#define FIT_MESG_SIZE_ALIGNED  256
#define FIT_MESG_DEF_SIZE   (FIT_MESG_DEF_HDR_SIZE + FIT_MAX_FIELD_COUNT * FIT_FIELD_DEF_SIZE)
...
#define FIT_BASE_MESG_DEFS_COUNT 67
#endif
