...
#JK#DEFINES += GC_WANT_PYTHON
#JK#DEFINES += "SIP_MODULE_NAME=\\\"sip\\\""
#JK#PYTHONINCLUDES = -I/usr/include/python3.13
#JK#PYTHONLIBS = -L/usr/lib/python3.13/config-3.13-x86_64-linux-gnu -lpython3.13
...
#JK#ICAL_INSTALL = /usr/lib
#ICAL_INCLUDE = 
#ICAL_LIBS    = /usr/lib/x86_64-linux-gnu/libical.a -licui18n -licuuc
...
#JK#LIBUSB_INSTALL = /usr
#LIBUSB_INCLUDE = 
#LIBUSB_LIBS    = 
#JK#LIBUSB_USE_V_1 = true # don't use on Windows
...
#JK#DEFINES += GC_VIDEO_VLC             # use VideoLan library needs VLC_INSTALL defined above
